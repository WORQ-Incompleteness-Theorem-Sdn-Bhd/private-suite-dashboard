...
export class ColorPaxService {
  ...
  readonly paxPalette = [
    'rgba(144, 238, 144, 0.50)',  // Smallest (2-4 pax) - 10% opacity: very light green
    'rgba(11, 218, 81, 0.50)', // 5-6 pax - 45% opacity: light green
    'rgba(76, 187, 23, 0.50)', // 7-8 pax - 60% opacity: medium-light green
    'rgba(0, 128, 0, 0.50)', // 9-12 pax - 75% opacity: medium green
    'rgba(53, 94, 59, 0.50)', // 13-20 pax - 90% opacity: strong green
    'rgba(0, 128, 0, 0.50)'   // Largest (21+ pax) - 100% opacity: full Available green #22c55e
  ] as const;
